...
\tsThe{(Algebra of Limits / Limit Laws)}{
    Assume
    \[
...
\tsThe{(Squeeze Theorem / Sandwich Theorem)}{
...
\tsThe{(Monotone Convergence Theorem / Weierstrass)}{
...
\tsCor{(Bolzano--Weierstrass Theorem)}{
