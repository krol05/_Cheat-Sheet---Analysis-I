...
\tsThe{(Supremum/Infimum)}{
    ...
    3. $\sup(X) \Leftrightarrow (\large \forall x\in X: x\le S) \land (\large \forall\varepsilon>0\ \exists x\in X: \ x>S-\varepsilon)$
    4. $\inf(X) \Leftrightarrow \large (\forall x\in X: x\ge I) \land (\forall\varepsilon>0\ \exists x\in X: \ x<I+\varepsilon)$
}
